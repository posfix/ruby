class Nonthreedpaymentrequest
    ...
    def execute(req, settings)
        ...
        settings.HashString =
            settings.PrivateKey + req.OrderId + req.Amount + req.Mode +
    ...
    def to_xml(req, settings)
        ...
        <auth>
                ...
                '</birthDate>
                    <gsmNumber>' + req.Purchaser.GsmPhone +
                '</gsmNumber>
                    <tcCertificate>' + req.Purchaser.IdentityNumber +
                '</tcCertificate>
                        <invoiceAddress>
                                <name>' + req.Purchaser.Invoiceaddress.Name +
                '</name>
                                <surname>' +
                req.Purchaser.Invoiceaddress.SurName +
                '</surname>
                                <address>' +
                req.Purchaser.Invoiceaddress.Address +
                '</address>
                                <zipcode>' +
                req.Purchaser.Invoiceaddress.ZipCode +
                '</zipcode>
                                <city>' +
                req.Purchaser.Invoiceaddress.CityCode +
                '</city>
                                <tcCertificate>' +
                req.Purchaser.Invoiceaddress.IdentityNumber +
                '</tcCertificate>
                                <country>' +
                req.Purchaser.Invoiceaddress.CountryCode +
                '</country>
                                <taxNumber>' +
                req.Purchaser.Invoiceaddress.TaxNumber +
                '</taxNumber>
                                <taxOffice>' +
                req.Purchaser.Invoiceaddress.TaxOffice +
                '</taxOffice>
                                <companyName>' +
                req.Purchaser.Invoiceaddress.CompanyName +
                '</companyName>
                                <phoneNumber>' +
                req.Purchaser.Invoiceaddress.PhoneNumber +
                '</phoneNumber>
                        </invoiceAddress>
                        <shippingAddress>
                ...
                '</country>
                        <phoneNumber>' +
                req.Purchaser.Shippingaddress.PhoneNumber +
                '</phoneNumber>
